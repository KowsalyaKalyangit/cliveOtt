...
class CategoryVideosone extends StatefulWidget {
  CategoryVideosone({
    super.key,
    this.index,
  });
  ...
  @override
  State<CategoryVideosone> createState() => _CategoryVideosoneState();
}

class _CategoryVideosoneState extends State<CategoryVideosone> {
  ...
  var url = [
    ...
    'https://cherritech.us/ott/upload/source/TurningRed.mp4',
    "https://cherritech.us/ott/upload/source/SPIDER-MAN_ NO WAY HOME - Official Trailer (HD).mp4",
    'https://cherritech.us/ott/upload/source/Luca.mp4',
    "https://cherritech.us/ott/upload/source/Black Adam – Official Trailer 1.mp4",
    "https://cherritech.us/ott/upload/source/Fantastic Beasts_ The Secrets of Dumbledore – Official Trailer.mp4",
  ];
