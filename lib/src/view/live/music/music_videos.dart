...
class MusicVideos extends StatefulWidget {
  MusicVideos({super.key, this.index, this.name});
  final int? index;
  final String? name;

  @override
  State<MusicVideos> createState() => _MusicVideosState();
}

class _MusicVideosState extends State<MusicVideos> {
  VideoPlayerController? _controller;
  var url = [
    'https://livectv.phando.com/8061/playlist.m3u8',
    'http://sabot.instastream.in:8888/INSYNC/INSYNC.m3u8',
    ...
    'https://livectv.phando.com/8005/playlist.m3u8'
  ];
